...
<style>
  body {{ font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;
         max-width: 680px; margin: 40px auto; padding: 0 16px; background: #f9fafb; color: #111; }}
  ...
  th {{ background: #1e293b; color: #fff; padding: 10px 12px; text-align: left; font-size: 0.75rem; white-space: nowrap; }}
  td {{ padding: 11px 12px; border-bottom: 1px solid #f1f5f9; font-size: 0.9rem; white-space: nowrap; }}
